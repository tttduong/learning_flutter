      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          actions: [
            ...
            SizedBox(width: 10),
            Icon(Icons.favorite_outline_rounded, color: Colors.blue),
            SizedBox(width: 10),
...
SizedBox(width: 10), 
                Column(
                  ...
                  Text('J.K. Rowling Howling', style: TextStyle(
                    fontSize: 14, 
                    fontWeight: FontWeight.w600,
                    fontFamily: 'Proxima Nova Alt', 
                  ),),
                  Text('12.5k readers', style: TextStyle(
                    fontSize: 12,
                    fontWeight: FontWeight.w400,
                    fontFamily: 'Proxima Nova Alt', 
                  ),),
